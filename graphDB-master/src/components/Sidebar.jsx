...
const Sidebar = () => {
  ...
  // Use useMemo to memoize menuItems so it doesn't change across renders
  const menuItems = useMemo(
    ...
    []
  ); // Empty dependency array to memoize menuItems
  ...
  }, [location.pathname, menuItems]); // Add menuItems to the dependency array
